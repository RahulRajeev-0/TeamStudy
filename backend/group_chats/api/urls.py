...
urlpatterns = [
    ...
    # list of member who is not in the group 
    path('workspace-group-adding-list/<int:group_id>/<int:request_id>/<int:workspace_id>/', views.NotMemberOfGroupView.as_view(), name='list-for-adding-to-group'),
    #  group views
